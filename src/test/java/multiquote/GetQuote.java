...
public class GetQuote {
	...
	public void getMultiQuote() throws IOException {
		...
		String testCar=ExcelUtils.readCellData(Constants.ExcelTestData,"loanStock",0,1);	
		...
		bodyData = JsonVariableReplacement.replaceJson(bodyData, "makeid",ExcelUtils.readCellData(Constants.ExcelTestData,"loanStock",2,15));
		bodyData = JsonVariableReplacement.replaceJson(bodyData, "modelid",ExcelUtils.readCellData(Constants.ExcelTestData,"loanStock",2,14));
		bodyData = JsonVariableReplacement.replaceJson(bodyData, "versionid",ExcelUtils.readCellData(Constants.ExcelTestData,"loanStock",2,4));
		bodyData = JsonVariableReplacement.replaceJson(bodyData, "makeyear",ExcelUtils.readCellData(Constants.ExcelTestData,"loanStock",2,3));
		...
		bodyData = JsonVariableReplacement.replaceJson(bodyData, "carPrice",ExcelUtils.readCellData(Constants.ExcelTestData,"loanStock",2,10));
